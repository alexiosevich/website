...
%\chapter{Moser's approach and the Erd\H{o}s integer distance
%principle}
...
This is known as the \index{term}{Cauchy-Schwartz inequality}\emph{Cauchy-Schwartz inequality}.
...
\Printindex{note}{Index of Notation}
\Printindex{term}{Index of Terminology and Names}
